...
# Check if the input is between 11 and 18 (inclusive)
if (( INPUT_POSTGRESQL_VERSION < 12 || INPUT_POSTGRESQL_VERSION > 18 )); then
    echo "Error: $INPUT_POSTGRESQL_VERSION is not between 12 and 18 (inclusive)."
    exit 1
fi
